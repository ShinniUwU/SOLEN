...
# --- Sanity Checks ---
command -v docker-compose >/dev/null 2>&1 || { echoerror "Error: docker-compose command not found. Is it installed and in your PATH?"; exit 1; }
...
ORIGINAL_DIR=$(pwd)
cd "$TARGET_DIR" || { echoerror "Could not change directory to $TARGET_DIR"; exit 1; }
